...
import '../constants/api_constants.dart'; // <-- اضافه شدن فایل ثابت‌ها
...
class OrderController extends GetxController {
  ...
  Future<bool> submitOrder(String paymentMethod) async {
    ...
    try {
      ...
      // ساخت بدنه درخواست (user_type اضافه شد)
      Map<String, dynamic> requestBody = {
        "profile_id": realProfileId, // استفاده از شناسه واقعی
        "user_type": "customer",     // <--- اضافه شد: ارسال نوع کاربر برای بک‌اند و سیستم چت
      ...
      // --- تغییرات آدرس‌دهی ---
      // استفاده مستقیم از آدرس پایه تعریف شده در فایل ثابت‌ها
